...
const menuGroups = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/bancada",     label: "Bancada",           icon: ic("M3.75 6.75h16.5M3.75 12h16.5m-16.5 5.25H12M3 3h18v18H3V3zm15 6H6v9h12V9z"), resource: "bancada" },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/ajuda",         label: "Central de Ajuda", icon: ic("M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z"), resource: "ajuda" },
    ],
  },
]
