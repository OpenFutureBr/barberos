...
export default function ConfiguracoesPage() {
  ...
  const [colapsados, setColapsados] = useState<Set<string>>(() => new Set([
    "aparencia", "fonte", "logo", "info", "contato", "endereco", "fiscal", "horario",
  ...
  return (
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSalvar} className="space-y-3">
        ...
        {/* Aparencia — modo de cor, acento e tonalidade (preferencia local do usuario) */}
        <Secao titulo="Aparência" id="aparencia" colapsados={colapsados} toggle={toggle}>
          <PainelAparencia />
        </Secao>
